...
public class ReaderServiceImplTest {
    ...
    public void createReader() {
        ...
        assertEquals(Long.valueOf(1L),result.getLibraryCard());
    }
    ...
    public void updateReader() {
        ...
        when(readerRepo.findById(reader.getLibraryCard())).thenReturn(Optional.of(reader));
        when(readerRepo.save(any(Reader.class))).thenReturn(reader);

        ReaderInfoResponse result=readerService.updateReader(reader.getLibraryCard(),request);
    ...
    public void deleteReader() {
        ...
        reader.setLibraryCard(1L);
        when(readerRepo.findById(reader.getLibraryCard())).thenReturn(Optional.of(reader));
        readerService.deleteReader(reader.getLibraryCard());
